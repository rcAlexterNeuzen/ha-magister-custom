...
async def _do_auth(
    ...
    Returns the authenticated client so callers can store the access token.
    """
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            try:
                ...
                return self._create_entry(school, username, password, totp_secret, client._access_token)
    ...
    async def async_step_reauth_confirm(
        ...
        if user_input is not None:
            ...
            try:
                ...
                new_data = {**entry.data, CONF_PASSWORD: new_password, CONF_ACCESS_TOKEN: client._access_token}
                if totp_secret:
